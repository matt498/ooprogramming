...
public class DataEntry_v3_Online_Model extends JFrame implements ActionListener {
	...
	DBManager db;
	DataEntry_v3_Model_Forward model;
	...
	public DataEntry_v3_Online_Model() throws SQLException {
		...
		model = new DataEntry_v3_Model_Forward(db);
	...
	public void showItem() {
		try {
			tfLenght.setText(new Double(model.getSelectedItem().getLenght()).toString());
			tfDiameter.setText(new Double(model.getSelectedItem().getDiameter()).toString());
			tfWeight.setText(new Double(model.getSelectedItem().getWeigth()).toString());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnNext) {
			...
			model.insert(Double.parseDouble(v[0]), 
